...
| Implementation-local choice | 고정 API 안의 내부 자료구조·알고리즘·구현 선택 | 좁고 검증 가능하면 Terra Light, 일반 구현은 Terra Medium부터 비교; Parent가 선택 Rule을 고정하면 Predetermined execution으로 재분류해 Luna Medium 비교 가능 |
